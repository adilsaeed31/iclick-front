...
class CartItems extends Component {
  ...
  render() {
    const { items, isMiniCart, isReadOnly, hasMoreCartItems, onLoadMoreCartItems } = this.props;
    ...
    return (
      <Fragment>
        ...
        {hasMoreCartItems && (
          <div>
            <Button isShortHeight={isMiniCart} isTextOnly onClick={onLoadMoreCartItems}>
              {"Load More"}
            </Button>
          </div>
        )}
