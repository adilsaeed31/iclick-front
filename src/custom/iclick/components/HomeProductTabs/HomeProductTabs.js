...
const HomeProductTabs = () => (
  <div className="home-product-tabs">
    ...
    <div className="tab-content">
      ...
      >
        <div className="container">
          <div className="tab-products-carousel owl-carousel owl-theme">
      ...
      <div className="tab-pane fade" id="latest-products" role="tabpanel" aria-labelledby="latest-products-tab">
        <div className="container">
          <div className="tab-products-carousel owl-carousel owl-theme">
            <div className="product">
              <figure className="product-image-container">
            ...
            <div className="product">
              <figure className="product-image-container">
                <a href="product.html" className="product-image">
                  <img src="/static/images/products/product-13.jpg" alt="product" />
                </a>
                <a href="ajax/product-quick-view.html" className="btn-quickview">
                  Quick View
                </a>
