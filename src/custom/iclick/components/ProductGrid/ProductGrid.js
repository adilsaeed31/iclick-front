...
export default class ProductGrid extends Component {
  ...
  @trackProductClicked()
  renderMainArea() {
    const { catalogItems, initialSize, isLoadingCatalogItems, pageInfo, pageSize, setPageSize } = this.props;
    ...
    return (
      <Fragment>
        <Grid container spacing={24}>
          ...
          <TagPagination pageSize={pageSize} setPageSize={setPageSize} pageInfo={pageInfo} />
        </Grid>
      </Fragment>
    );
  }
