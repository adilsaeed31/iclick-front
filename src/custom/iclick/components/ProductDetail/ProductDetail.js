                ...
                <div className="product-single-container product-single-default">
                  <div className="row">
                    ...
                    <div className="col-lg-5 col-md-6">
                      ...
                      <ProductDetailTitle className="product-title" pageTitle={product.pageTitle} title={product.title} />
                        ...
                        {/* <ProductDetailPrice className="product-price" compareAtPrice={compareAtDisplayPrice} price={productPrice.displayPrice} /> */}
                          <span className="old-price">{compareAtDisplayPrice}</span>
                          <span className="product-price">{productPrice.displayPrice}</span>
                        </div>
                        <ProductDetailDescription className="product-desc">
                        {product.description}
